...
if __name__ == "__main__":
    ...
    if ci_manager.is_travis():
        if manager.get_branch() == "stable/3.6.1" and not manager.is_pull_request() and os.getenv("CONAN_CLANG_VERSIONS") == "6.0" and os.getenv("CONAN_ARCHS") == "x86_64":
        ...
        if manager.get_branch() == "stable/3.6.1" and not manager.is_pull_request() and os.getenv("CONAN_VISUAL_VERSIONS") == "15" and os.getenv("CONAN_BUILD_TYPES") == "Debug":
